  ...
  return (
    <>
      <div className="carousel carousel-center bg-neutral rounded-box space-x-4 p-4">
        <div className="carousel-item bg-[url('./src/assets/images/443900463_1497658181105760_4024221241233185618_n.jpg')] w-[300px] h-[300px] rounded-box bg-cover">
        ...
        <div className="carousel-item bg-[url('./src/assets/images/jeans-428614_1280.jpg')] w-[300px] h-[300px] rounded-box bg-cover">
          <div className="card-body flex ">
        ...
        <div className="carousel-item bg-[url('./src/assets/images/469806188_122152731050289777_1161863373712766166_n.jpg')] w-[300px] h-[300px] rounded-box bg-cover">
          <div className="card-body flex ">
        ...
        <div className="carousel-item bg-[url('./src/assets/images/454236377_1025698259207159_1465278236567567516_n.jfif')] w-[300px] h-[300px] rounded-box bg-cover">
          <div className="card-body flex ">
            <h2 className="card-title justify-end uppercase  text-amber-100">
        ...
        <div className="carousel-item bg-[url('./src/assets/images/455264203_1033709845068951_8863746397986071115_n.jfif')] w-[300px] h-[300px] rounded-box bg-cover">
          <div className="card-body flex ">
        ...
        <div className="carousel-item bg-[url('./src/assets/images/444990111_412716188294508_5175143283363269065_n.jpg')] w-[300px] h-[300px] rounded-box bg-cover">
          <div className="card-body flex ">
            <h2 className="card-title justify-end uppercase text-amber-100">
      ...
      <div className="flex justify-center items-center gap-2 md:w-[50%] mx-auto ">
        <div className="card bg-base-100 image-full shadow-sm mt-4">
          <figure>
            <img
              src="./src/assets/images/man-5693573_1280.jpg"
              alt="Shoes"
              height="300"
              width="300"
            />
        ...
        <div className="card bg-base-100 image-full shadow-sm mt-4">
          <figure>
            <img
              src="./src/assets/images/for_her.jfif"
              alt="Shoes"
              height="300"
              width="300"
            />
